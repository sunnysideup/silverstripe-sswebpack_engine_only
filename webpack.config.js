...
const THEME_DIR_PROVIDED = process.env.npm_config_theme_dir || 'themes/error-use-theme_dir-parameter-to-set-target-folder'
...
console.log('               =    ' + THEME_DIR_PROVIDED.replace(path.resolve(ROOT_DIR_PROVIDED), './'))
